...
export default function InGamgeHeader({openSurrenderModal}){
    ...
    return(<>
        <Grid container className='in-game-header-grid'>
            ...
            <Grid item xs={3} justifyContent={"center"}><SurrenderButton openSurrenderModal={openSurrenderModal}/></Grid>
        </Grid>
    </>)
}